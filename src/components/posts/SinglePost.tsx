...
const SinglePost: FC<SinglePostProps> = ({
    ...
    >
        <div className="bg-[#f6f6f7] border-b border-b-gray-300 p-4 flex items-baseline justify-end gap-x-12">
            ...
            <div className="flex gap-2"><div className="flex flex-col items-center cursor-pointer"
        ...
        <div className="flex flex-col items-center mb-32 p-2">
            ...
            <div className="flex flex-col self-end max-w-[240px] mt-3 mr-2 gap-1">
                ...
                <p className="flex items-center text-gray-500 self-end text-xs font-semibold">Delivered</p>
            </div>
        </div>
    </div>
);
